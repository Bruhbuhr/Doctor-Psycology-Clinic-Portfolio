    ...
    <section id="home" class="pt-32 pb-20 lg:pt-44 lg:pb-32 px-4 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div class="space-y-8 animate-fade-in-up">
          ...
          <div class="inline-flex items-center gap-2 text-xs sm:text-sm text-slate-600 bg-white border border-slate-200 rounded-full px-4 py-2">
            <span class="text-emerald-600">●</span>
            Bảo mật thông tin tuyệt đối • Khám riêng tư 1:1
          </div>
